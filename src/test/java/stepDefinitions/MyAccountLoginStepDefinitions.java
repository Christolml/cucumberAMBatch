...
public class MyAccountLoginStepDefinitions {
	...
	public void open_browser() throws Throwable {
		System.setProperty("webdriver.chrome.driver", "C://Users//ChristopherEmmanuell//Downloads//chromedriver_win32//chromedriver.exe");
...
/*	@And("^Enter registered username \"([^\"]*)\" and password \"([^\"]*)\"$")
	public void enter_registered_username_and_password(String username, String pwd) throws Throwable {
...
/*	@Then("^Verify login$")
	...
	public void usert_must_successfully_login_to_the_web_page() throws Throwable {
